...
\begin{table}[t]
\centering
\caption{EF-Net subject-dependent results (VP001--VP003, same protocol as Arif et al.\ Table~2: 80/20 split within each subject's own samples). We report both our block/trial-level split (Clean) and our overlapping-window shuffled split (Leaked) to empirically replicate the paper's results. }
