...
fNIRS only & N/A & N/A & 0.638 \\
EEG only & N/A & N/A & 0.567 \\
\bottomrule
\end{tabular}
\\[2pt] \footnotesize\textit{fNIRS-only / EEG-only ablations pending -- N/A rows will populate automatically once those runs complete.}
\end{table}
...
\begin{table}[t]
\centering
\caption{EF-Net subject-dependent results (VP001-VP003) \emph{(pending -- placeholder shown)}.}
\label{tab:subjectdep}
\footnotesize
\begin{tabular}{c}
\toprule
\textit{Subject-dependent EF-Net run (matching paper Table 2 protocol) is queued/running.} \\
\midrule
Results not yet available at manuscript generation time. \\
Re-run \texttt{generate\_paper\_tex.py} after the run completes. \\
\bottomrule
\end{tabular}
\end{table}
...
\midrule
VP001 & 0.424 & 0.374 & 0.7061 \\
VP002 & 0.471 & 0.437 & 1.2803 \\
VP003 & 0.502 & 0.506 & 0.9618 \\
VP004 & 0.367 & 0.326 & 0.8430 \\
VP005 & 0.355 & 0.352 & 1.0152 \\
\bottomrule
\end{tabular}
\end{table}
